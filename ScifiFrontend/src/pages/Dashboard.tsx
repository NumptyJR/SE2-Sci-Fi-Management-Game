...
import { CreditCard, TrendingUp, Shield, AlertTriangle } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="border-cyan-500/20 bg-card/90 mb-8">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Use in Planetary Outlook to satisfy planet needs.</p>
          </CardHeader>
          <CardContent>
